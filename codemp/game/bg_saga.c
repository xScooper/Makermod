...
//Makermod Start
char		test_info[MAX_MAKERMOD_INFO];
char		npc_info[MAX_MAKERMOD_INFO];
char		npcv_info[MAX_MAKERMOD_INFO];
char		anims_info[MAX_MAKERMOD_INFO];
char		anims2_info[MAX_MAKERMOD_INFO];
char		anims3_info[MAX_MAKERMOD_INFO];
char		perms_info[MAX_MAKERMOD_INFO];
//Makermod End
