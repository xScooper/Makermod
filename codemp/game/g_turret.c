...
//------------------------------------------------------------------------------------------------------------
{
	...
	RemoveUse( &(g_entities[self->r.ownerNum]), turret_base_use );
...
qboolean turret_base_spawn_top( gentity_t *base )
{
	...
	top->creator = base->creator;

	top->model = "models/map_objects/hoth/turret_top_new.md3";
	top->model2 = "models/map_objects/hoth/turret_top.md3";
