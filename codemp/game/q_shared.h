...
// Makermod - Scooper
static ID_INLINE vecd_t VectorLengthD( const vecd3_t v ) {
	return (vec_t)sqrt (v[0]*v[0] + v[1]*v[1] + v[2]*v[2]);
}
...
static ID_INLINE void CrossProductD( const vecd3_t v1, const vecd3_t v2, vecd3_t cross ) {
	cross[0] = v1[1]*v2[2] - v1[2]*v2[1];
	cross[1] = v1[2]*v2[0] - v1[0]*v2[2];
	cross[2] = v1[0]*v2[1] - v1[1]*v2[0];
}
...
// Makermod
float VectorAngle2D( const vecd3_t a, const vecd3_t b );
// Makermod end
...
//Makermod
void RotatePointAroundVectorD( vecd3_t dst, const vecd3_t dir, const vecd3_t point, float degrees );
//Makermod end
...
// Makermod - Scooper
void PerpendicularVectorD( vecd3_t dst, const vecd3_t src );
void MatrixMultiplyD(double in1[3][3], double in2[3][3], double out[3][3]);
