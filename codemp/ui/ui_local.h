...
#define MAX_NPCV 700
#define MAX_ANIM 700
#define MAX_ANIM2 700
#define MAX_ANIM3 700
#define MAX_PERM 700
//Makermod End
...
//	characterInfo characterList[MAX_HEADS];
	...
	const char *md3List[MAX_MD3S];//CODE1234
	int md3Count;
	int md3Index;

	const char *efxList[MAX_EFXS];
	int efxCount;
	int efxIndex;

	const char *NPCList[MAX_NPC];
	int NPCCount;
	int NPCIndex;

	const char *NPCVList[MAX_NPCV];
	int NPCVCount;
	int NPCVIndex;

	const char *AnimList[MAX_ANIM];
	int AnimCount;
	int AnimIndex;

	const char *Anim2List[MAX_ANIM2];
	int Anim2Count;
	int Anim2Index;

	const char *Anim3List[MAX_ANIM3];
	int Anim3Count;
	int Anim3Index;

	const char *PermList[MAX_PERM];
	int PermCount;
	int PermIndex;
