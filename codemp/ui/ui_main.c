...
static const serverFilter_t serverFilters[] = {
	{"MENUS_ALL", "" },
	{"MENUS_JEDI_ACADEMY", "" },
	{"MENUS_MAKERMOD", "makermod" },//MAKERMOD
};
...
================
*/
void UI_Draw3DModel( rectDef_t *rect, qhandle_t model, void *ghoul2, int g2radius, qhandle_t skin, vec3_t origin, vec3_t angles ) {
	refdef_t		refdef;
	refEntity_t		ent;
...
void UI_Call3DModel(rectDef_t *rect) {
	float			len;
...
//		menu = Menu_GetFocused();
		...
		strcpy(test, "models/map_objects/");
		strcat(test, uiInfo.md3List[uiInfo.md3Index]);
		strcat(test, ".md3");

//		item = (itemDef_t *) Menu_FindItemByName((menuDef_t *) menu, "bigtest");
//		memcpy(&item->window.rectClient, rect, sizeof(rectDef_t));

		handle = trap_R_RegisterModel( test );
		trap_Cvar_Set("ui_ttest", test);
//		handle = trap_R_RegisterModel( "effects/ships/dest_destroyed.efx" );


//		handle = uiInfo.md3List[uiInfo.md3Index];
...
//		origin[0] = len / 0.268;	// len / tan( fov/2 )
		...
		angles[YAW] = trap_Cvar_VariableValue( "ui_rotate" );
		angles[0] = trap_Cvar_VariableValue( "ui_pitch" );
		angles[2] = trap_Cvar_VariableValue( "ui_tilt" );
		origin[0] = trap_Cvar_VariableValue( "ui_zoom" );

		UI_Draw3DModel(&(*rect), handle, NULL, 0, 0, origin, angles );
}
...
//Makermod plugin START
static qboolean UI_Makermod_Main_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	{
		item = Menu_FindItemByName(menu, "cheats");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "emotes");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "player");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "tele");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "placing");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "manip");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "properties");
	}
	else if (key == A_8)
	{
		item = Menu_FindItemByName(menu, "saving");
	}
	else if (key == A_9)
	{
		item = Menu_FindItemByName(menu, "admin");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Cheats_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (!menu)
	{
	 ...
	 if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "cheats_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "cheats_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "cheats_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "cheats_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "cheats_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "cheats_06");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backCheats");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_EmotesChoice_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "emoteschoice");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "animationschoice");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backEmotesChoice");
	}
		else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Emotes_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "emotes_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "emotes_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "emotes_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "emotes_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "emotes_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "emotes_06");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "emotes_07");
	}
	else if (key == A_8)
	{
		item = Menu_FindItemByName(menu, "emotes_08");
	}
	else if (key == A_9)
	{
		item = Menu_FindItemByName(menu, "emotes_09");
	}
	else if (key == A_0)
	{
		item = Menu_FindItemByName(menu, "emotes_10");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backEmotes");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Emotes2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "emotes2_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "emotes2_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "emotes2_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "emotes2_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "emotes2_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "emotes2_06");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "emotes2_07");
	}
	else if (key == A_8)
	{
		item = Menu_FindItemByName(menu, "emotes2_08");
	}
	else if (key == A_9)
	{
		item = Menu_FindItemByName(menu, "emotes2_09");
	}
	else if (key == A_0)
	{
		item = Menu_FindItemByName(menu, "emotes2_10");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backEmotes2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Emotes3_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "emotes3_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "emotes3_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "emotes3_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "emotes3_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "emotes3_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "emotes3_06");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "emotes3_07");
	}
	else if (key == A_8)
	{
		item = Menu_FindItemByName(menu, "emotes3_08");
	}
	else if (key == A_9)
	{
		item = Menu_FindItemByName(menu, "emotes3_09");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backEmotes3");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Player_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "player_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "player_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "player_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "player_04");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backPlayer");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Mscaleme_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mscaleme_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMScaleme");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Mscalet_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mscalet_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMScalet");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Tele_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "tele_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "tele_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "tele_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "tele_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "tele_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "tele_06");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backTele");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Mtele_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mtele_01");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "mtele_03");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMTele");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Placing_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "placing_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "placing_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "placing_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "placing_04");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backPlacing");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Manip_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "manip_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "manip_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "manip_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "manip_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "manip_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "manip_06");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "manip_07");
	}
	else if (key == A_8)
	{
		item = Menu_FindItemByName(menu, "manip_08");
	}
	else if (key == A_9)
	{
		item = Menu_FindItemByName(menu, "manip_09");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backManip");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Manip2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "manip2_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "manip2_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "manip2_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "manip2_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "manip2_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "manip2_06");
	}
	else if (key == A_7)
	{
		item = Menu_FindItemByName(menu, "manip2_07");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backManip2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Properties_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "properties_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "properties_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "properties_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "properties_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "properties_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "properties_06");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backProperties");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_MListobs_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mlistobs_02");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "mlistobs_03");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfrommanip" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMListobs");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommselect" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMListobs2");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_MSelect_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mselect_02");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "mselect_03");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "mselect_04");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfrommanip" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMSelect");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommlistobs" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMSelect2");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_Marm_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "marm_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMArm");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mPlace_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMPlace");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mPlacefx_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMPlacefx");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mPlacefx2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mplacefx2_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMPlacefx2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mMove_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mmove_mmoveall");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "mmove_mrotate");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfrommanip2" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMove");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplace" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMove2");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplacefx" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMove3");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommmoveall" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMove4");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_mMoveAll_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mmoveall_mmove");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "mmoveall_mrotate");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfrommanip2" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMoveAll");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplace" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMoveAll2");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplacefx" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMoveAll3");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommmove" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMMoveAll4");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_mRotate_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfrommanip2" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMRotate");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommmove" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMRotate2");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommmoveall" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMRotate3");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplace" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMRotate4");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfrommplacefx" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backMRotate5");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_mPain_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mpain_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMPain");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mBreakAble_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mbreakable_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMBreakAble");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mBreakAbleAll_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mbreakableall_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMBreakAbleAll");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Mscale_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "mscale_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMScale");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Saving_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "saving_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "saving_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backSaving");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Admin_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "admin_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "admin_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdmin");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Admin2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "admin2_02");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "admin2_03");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdmin2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminC_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminc_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminc_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminc");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminUS_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminus_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminus_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "adminus_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "adminus_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "adminus_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "adminus_06");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUS");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminSlapSlay_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backSlapSlay");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminKickBan_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backKickBan");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminUS2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "adminus2_03");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUS2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mNewUser_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminup2_02");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminup2_03");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUP2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminUP_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminup_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminup_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "adminup_03");
	}
	else if ((key == A_4) || ( key == A_STRING))
	{
		item = Menu_FindItemByName(menu, "adminup_04");
	}
	else if ((key == A_5) || ( key == A_PERCENT))
	{
		item = Menu_FindItemByName(menu, "adminup_05");
	}
	else if ((key == A_6) || ( key == A_CARET))
	{
		item = Menu_FindItemByName(menu, "adminup_06");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUP");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mChangePass_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminup3_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUP3");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mResetPass_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminup4_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUP4");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_NPCS_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "npcs_01");
	}
	else if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "npcs_02");
	}
	else if ((key == A_3) || ( key == A_HASH))
	{
		item = Menu_FindItemByName(menu, "npcs_03");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backNPCS");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_NPCSS_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backNPCSS");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_NPCVSS_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backNPCVSS");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_MAnims_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backMAnims");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mPermissions_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "adminup5_02");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminUP5");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_mPermission_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminup6_03");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfromnew" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backAdminUP6a");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfromperms" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backAdminUP6b");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfromforbid" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backAdminUP6c");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_mForbid_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_2) || ( key == A_AT))
	{
		item = Menu_FindItemByName(menu, "adminup7_03");
	}
	else if (key == A_BACKSPACE)
	{
	 if( trap_Cvar_VariableValue( "ui_backfromperm" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backAdminUP7a");
	 }
	 else if( trap_Cvar_VariableValue( "ui_backfromperms" ) == 1 )
	 {
		item = Menu_FindItemByName(menu, "backAdminUP7b");
	 }
	}
	else
	{
...
static qboolean UI_Makermod_Saving2_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "saving2_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backSaving2");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_Saving3_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if ((key == A_1) || ( key == A_PLING))
	{
		item = Menu_FindItemByName(menu, "saving3_01");
	}
	else if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backSaving3");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_Makermod_AdminTele_HandleKey(int key) 
{
	menuDef_t *menu;
	itemDef_t *item;
	...
	if (key == A_BACKSPACE)
	{
		item = Menu_FindItemByName(menu, "backAdminTele");
	}
	else
	{
		return (qfalse);
...
static qboolean UI_OwnerDrawHandleKey(int ownerDraw, int flags, float *special, int key) {
  ...
  switch (ownerDraw) {
    ...
    case UI_FORCE_RANK:
		break;		
	case UI_MAKERMOD_MAIN:
		return UI_Makermod_Main_HandleKey(key);
		break;
	case UI_MAKERMOD_CHEATS:
		return UI_Makermod_Cheats_HandleKey(key);
		break;
	case UI_MAKERMOD_EMOTESCHOICE:
		return UI_Makermod_EmotesChoice_HandleKey(key);
		break;
	case UI_MAKERMOD_EMOTES:
		return UI_Makermod_Emotes_HandleKey(key);
		break;
	case UI_MAKERMOD_EMOTES2:
		return UI_Makermod_Emotes2_HandleKey(key);
		break;
	case UI_MAKERMOD_EMOTES3:
		return UI_Makermod_Emotes3_HandleKey(key);
		break;
	case UI_MAKERMOD_PLAYER:
		return UI_Makermod_Player_HandleKey(key);
		break;
	case UI_MAKERMOD_MSCALEME:
		return UI_Makermod_Mscaleme_HandleKey(key);
		break;
	case UI_MAKERMOD_MSCALET:
		return UI_Makermod_Mscalet_HandleKey(key);
		break;
	case UI_MAKERMOD_TELE:
		return UI_Makermod_Tele_HandleKey(key);
		break;
	case UI_MAKERMOD_MTELE:
		return UI_Makermod_Mtele_HandleKey(key);
		break;
	case UI_MAKERMOD_PLACING:
		return UI_Makermod_Placing_HandleKey(key);
		break;
	case UI_MAKERMOD_MANIP:
		return UI_Makermod_Manip_HandleKey(key);
		break;
	case UI_MAKERMOD_MANIP2:
		return UI_Makermod_Manip2_HandleKey(key);
		break;
	case UI_MAKERMOD_MLISTOBS:
		return UI_Makermod_MListobs_HandleKey(key);
		break;
	case UI_MAKERMOD_MSELECT:
		return UI_Makermod_MSelect_HandleKey(key);
		break;
	case UI_MAKERMOD_MARM:
		return UI_Makermod_Marm_HandleKey(key);
		break;
	case UI_MAKERMOD_MPLACE:
		return UI_Makermod_mPlace_HandleKey(key);
		break;
	case UI_MAKERMOD_MMOVE:
		return UI_Makermod_mMove_HandleKey(key);
		break;
	case UI_MAKERMOD_MMOVEALL:
		return UI_Makermod_mMoveAll_HandleKey(key);
		break;
	case UI_MAKERMOD_MROTATE:
		return UI_Makermod_mRotate_HandleKey(key);
		break;
	case UI_MAKERMOD_MPLACEFX:
		return UI_Makermod_mPlacefx_HandleKey(key);
		break;
	case UI_MAKERMOD_MPLACEFX2:
		return UI_Makermod_mPlacefx2_HandleKey(key);
		break;
	case UI_MAKERMOD_MPAIN:
		return UI_Makermod_mPain_HandleKey(key);
		break;
	case UI_MAKERMOD_MBREAKABLE:
		return UI_Makermod_mBreakAble_HandleKey(key);
		break;
	case UI_MAKERMOD_MBREAKABLEALL:
		return UI_Makermod_mBreakAbleAll_HandleKey(key);
		break;
	case UI_MAKERMOD_PROPERTIES:
		return UI_Makermod_Properties_HandleKey(key);
		break;
	case UI_MAKERMOD_MSCALE:
		return UI_Makermod_Mscale_HandleKey(key);
		break;
	case UI_MAKERMOD_SAVING:
		return UI_Makermod_Saving_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMIN:
		return UI_Makermod_Admin_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMIN2:
		return UI_Makermod_Admin2_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINC:
		return UI_Makermod_AdminC_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINUS:
		return UI_Makermod_AdminUS_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINUS2:
		return UI_Makermod_AdminUS2_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINSLAPSLAY:
		return UI_Makermod_AdminSlapSlay_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINKICKBAN:
		return UI_Makermod_AdminKickBan_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINUP:
		return UI_Makermod_AdminUP_HandleKey(key);
		break;
	case UI_MAKERMOD_MNEWUSER:
		return UI_Makermod_mNewUser_HandleKey(key);
		break;	
	case UI_MAKERMOD_MCHANGEPASS:
		return UI_Makermod_mChangePass_HandleKey(key);
		break;
	case UI_MAKERMOD_MRESETPASS:
		return UI_Makermod_mResetPass_HandleKey(key);
		break;
	case UI_MAKERMOD_NPCS:
		return UI_Makermod_NPCS_HandleKey(key);
		break;
	case UI_MAKERMOD_NPCSS:
		return UI_Makermod_NPCSS_HandleKey(key);
		break;
	case UI_MAKERMOD_NPCVSS:
		return UI_Makermod_NPCVSS_HandleKey(key);
		break;
	case UI_MAKERMOD_MANIMS:
		return UI_Makermod_MAnims_HandleKey(key);
		break;
	case UI_MAKERMOD_MPERMISSIONS:
		return UI_Makermod_mPermissions_HandleKey(key);
		break;
	case UI_MAKERMOD_MPERMISSION:
		return UI_Makermod_mPermission_HandleKey(key);
		break;
	case UI_MAKERMOD_MFORBID:
		return UI_Makermod_mForbid_HandleKey(key);
		break;
	case UI_MAKERMOD_SAVING2:
		return UI_Makermod_Saving2_HandleKey(key);
		break;
	case UI_MAKERMOD_SAVING3:
		return UI_Makermod_Saving3_HandleKey(key);
		break;
	case UI_MAKERMOD_ADMINTELE:
		return UI_Makermod_AdminTele_HandleKey(key);
		break;
	case UI_CHAT_MAIN:
...
void UI_LoadNPCs() {
	...
	length = trap_FS_FOpenFile("pluginfiles/npcs.scpr", &fh, FS_READ);
	...
	trap_FS_Read(npc_info, length, fh);
	npc_info[sizeof(npc_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.NPCCount < 1024; i++, uiInfo.NPCCount++)
	{
		uiInfo.NPCList[uiInfo.NPCCount] = &npc_info[i];
		do
		{
			if( npc_info[i] == '\r' || npc_info[i] == '\n' )
			{
				while(npc_info[i] == '\r' || npc_info[i] == '\n')
				{
				npc_info[i++] = 0;
				}
				i--;
...
void UI_LoadNPCVs() {
	...
	length = trap_FS_FOpenFile("pluginfiles/npcvs.scpr", &fh, FS_READ);
	...
	trap_FS_Read(npcv_info, length, fh);
	npcv_info[sizeof(npcv_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.NPCVCount < 1024; i++, uiInfo.NPCVCount++)
	{
		uiInfo.NPCVList[uiInfo.NPCVCount] = &npcv_info[i];
		do
		{
			if( npcv_info[i] == '\r' || npcv_info[i] == '\n' )
			{
				while(npcv_info[i] == '\r' || npcv_info[i] == '\n')
				{
				npcv_info[i++] = 0;
				}
				i--;
...
void UI_LoadAnims() {
	...
	length = trap_FS_FOpenFile("pluginfiles/animations1.scpr", &fh, FS_READ);
	...
	trap_FS_Read(anims_info, length, fh);
	anims_info[sizeof(anims_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.AnimCount < length; i++, uiInfo.AnimCount++)
	{
		uiInfo.AnimList[uiInfo.AnimCount] = &anims_info[i];
		do
		{
			if( anims_info[i] == '\r' || anims_info[i] == '\n' )
			{
				while(anims_info[i] == '\r' || anims_info[i] == '\n')
				{
				anims_info[i++] = 0;
				}
				i--;
...
void UI_LoadAnims2() {
	...
	length = trap_FS_FOpenFile("pluginfiles/animations2.scpr", &fh, FS_READ);
	...
	trap_FS_Read(anims2_info, length, fh);
	anims2_info[sizeof(anims2_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.Anim2Count < length; i++, uiInfo.Anim2Count++)
	{
		uiInfo.Anim2List[uiInfo.Anim2Count] = &anims2_info[i];
		do
		{
			if( anims2_info[i] == '\r' || anims2_info[i] == '\n' )
			{
				while(anims2_info[i] == '\r' || anims2_info[i] == '\n')
				{
				anims2_info[i++] = 0;
				}
				i--;
...
void UI_LoadAnims3() {
	...
	length = trap_FS_FOpenFile("pluginfiles/animations3.scpr", &fh, FS_READ);
	...
	trap_FS_Read(anims3_info, length, fh);
	anims3_info[sizeof(anims3_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.Anim3Count < length; i++, uiInfo.Anim3Count++)
	{
		uiInfo.Anim3List[uiInfo.Anim3Count] = &anims3_info[i];
		do
		{
			if( anims3_info[i] == '\r' || anims3_info[i] == '\n' )
			{
				while(anims3_info[i] == '\r' || anims3_info[i] == '\n')
				{
				anims3_info[i++] = 0;
				}
				i--;
...
void UI_LoadPerms() {
	...
	length = trap_FS_FOpenFile("pluginfiles/permissions.scpr", &fh, FS_READ);
	...
	trap_FS_Read(perms_info, length, fh);
	perms_info[sizeof(perms_info)-1] = 0;	//ensure null terminated

	trap_FS_FCloseFile(fh);

	for ( i = 0; i < length && uiInfo.PermCount < 1024; i++, uiInfo.PermCount++)
	{
		uiInfo.PermList[uiInfo.PermCount] = &perms_info[i];
		do
		{
			if( perms_info[i] == '\r' || perms_info[i] == '\n' )
			{
				while(perms_info[i] == '\r' || perms_info[i] == '\n')
				{
				perms_info[i++] = 0;
				}
				i--;
...
===============
*/
static void UI_LoadMd3s() {
	char	md3list[20000];
	char md3Ext[32];
	char	*md3name;
	int		i, len;

	Com_sprintf(md3Ext, sizeof(md3Ext), "md3");


	uiInfo.md3Count = trap_FS_GetFileList( "models/map_objects", md3Ext, md3list, 20000 );

	Com_sprintf(md3Ext, sizeof(md3Ext), ".md3");

	if (uiInfo.md3Count) {
		if (uiInfo.md3Count > MAX_MD3S) {
			uiInfo.md3Count = MAX_MD3S;
		}
		md3name = md3list;
		for ( i = 0; i < uiInfo.md3Count; i++ ) {
			len = strlen( md3name );
			if (!Q_stricmp(md3name +  len - strlen(md3Ext), md3Ext)) {
				md3name[len-strlen(md3Ext)] = '\0';
			}
			Q_strupr(md3name);
			uiInfo.md3List[i] = String_Alloc(md3name);
			md3name += len + 1;
		}
	}
...
===============
*/
static void UI_LoadEfxs() {
	char	efxlist[20000];
	char efxExt[32];
	char	*efxname;
	int		i, len;

	Com_sprintf(efxExt, sizeof(efxExt), "efx");


	uiInfo.efxCount = trap_FS_GetFileList( "effects", efxExt, efxlist, 20000 );

	Com_sprintf(efxExt, sizeof(efxExt), ".efx");

	if (uiInfo.efxCount) {
		if (uiInfo.efxCount > MAX_EFXS) {
			uiInfo.efxCount = MAX_EFXS;
		}
		efxname = efxlist;
		for ( i = 0; i < uiInfo.efxCount; i++ ) {
			len = strlen( efxname );
			if (!Q_stricmp(efxname +  len - strlen(efxExt), efxExt)) {
				efxname[len-strlen(efxExt)] = '\0';
			}
			Q_strupr(efxname);
			uiInfo.efxList[i] = String_Alloc(efxname);
			efxname += len + 1;
		}
	}
...
static void UI_RunMenuScript(char **args) 
{
	...
	if (String_Parse(args, &name)) 
	{
		...
		//	trap_Cvar_Set("ui_singlePlayerActive", "0");
			...
			UI_LoadDemos(); 
		} else if (Q_stricmp(name, "LoadMd3s") == 0) {
			UI_LoadMd3s();
		} else if (Q_stricmp(name, "LoadEfxs") == 0) {
			UI_LoadEfxs();
		} else if (Q_stricmp(name, "LoadNPCs") == 0) {
			UI_LoadNPCs();
		} else if (Q_stricmp(name, "LoadNPCVs") == 0) {
			UI_LoadNPCVs();
		} else if (Q_stricmp(name, "LoadAnims") == 0) {
			UI_LoadAnims();
		} else if (Q_stricmp(name, "LoadAnims2") == 0) {
			UI_LoadAnims2();
		} else if (Q_stricmp(name, "LoadAnims3") == 0) {
			UI_LoadAnims3();
		} else if (Q_stricmp(name, "LoadPerms") == 0) {
			UI_LoadPerms();
		} else if (Q_stricmp(name, "mAdminSlay") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("mslay \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		}
		} else if (Q_stricmp(name, "mAdminSlap") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("mslap \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		}
		} else if (Q_stricmp(name, "mAdminKick") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("mkick \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		}
		} else if (Q_stricmp(name, "mAdminBan") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("mban \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		}
		} else if (Q_stricmp(name, "mTeleTo") == 0) {
			if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
				trap_Cmd_ExecuteText( EXEC_APPEND, va("mtele \"%i\"\n",uiInfo.playerIndexes[uiInfo.playerIndex]) );
		} 
		}/* else if (Q_stricmp(name, "GetMenuLast") == 0) {
			menuDef_t *menu;

			menu = Menu_GetFocused();

			trap_Cvar_Set("ui_menuname", menu2);
//			trap_Cmd_ExecuteText(EXEC_APPEND, va("set ui_menuname %f", menu));
		...
		} else if (Q_stricmp(name, "PlaceMd3") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, va("mplace \"%s\"\n", uiInfo.md3List[uiInfo.md3Index]));
		} else if (Q_stricmp(name, "SpawnNPC") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, va("npc spawn \"%s\"\n", uiInfo.NPCList[uiInfo.NPCIndex]));
		} else if (Q_stricmp(name, "SpawnNPCV") == 0) {
			trap_Cmd_ExecuteText( EXEC_APPEND, va("npc spawn vehicle \"%s\"\n", uiInfo.NPCVList[uiInfo.NPCVIndex]));
...
static int UI_FeederCount(float feederID) 
{
	...
	switch ( (int)feederID )
	{
		...
		case FEEDER_MD3:
			return uiInfo.md3Count;
		case FEEDER_EFX:
			return uiInfo.efxCount;
		case FEEDER_NPCS:
			return uiInfo.NPCCount;
		case FEEDER_NPCVS:
			return uiInfo.NPCVCount;
		case FEEDER_ANIMS:
			return uiInfo.AnimCount;
		case FEEDER_ANIMS2:
			return uiInfo.Anim2Count;
		case FEEDER_ANIMS3:
			return uiInfo.Anim3Count;
		case FEEDER_PERMS:
			return uiInfo.PermCount;
			//MAKERMOD END
		case FEEDER_MOVES :
...
static const char *UI_FeederItemText(float feederID, int index, int column, 
	...
	*handle1 = *handle2 = *handle3 = -1;
	...
	} else if (feederID == FEEDER_MD3) {
		if (index >= 0 && index < uiInfo.md3Count) {// CODE1234
			return uiInfo.md3List[index];
		}
	} else if (feederID == FEEDER_EFX) {
		if (index >= 0 && index < uiInfo.efxCount) {
			return uiInfo.efxList[index];
		}
	} else if (feederID == FEEDER_NPCS) {
		if (index >= 0 && index < uiInfo.NPCCount) {
			return uiInfo.NPCList[index];
		}
	} else if (feederID == FEEDER_NPCVS) {
		if (index >= 0 && index < uiInfo.NPCVCount) {
			return uiInfo.NPCVList[index];
		}
	} else if (feederID == FEEDER_ANIMS) {
		if (index >= 0 && index < uiInfo.AnimCount) {
			return uiInfo.AnimList[index];
		}
	} else if (feederID == FEEDER_ANIMS2) {
		if (index >= 0 && index < uiInfo.Anim2Count) {
			return uiInfo.Anim2List[index];
		}
	} else if (feederID == FEEDER_ANIMS3) {
		if (index >= 0 && index < uiInfo.Anim3Count) {
			return uiInfo.Anim3List[index];
		}
	} else if (feederID == FEEDER_PERMS) {
		if (index >= 0 && index < uiInfo.PermCount) {
			return uiInfo.PermList[index];
		}
	} //MAKERMOD END
...
qboolean UI_FeederSelection(float feederFloat, int index, itemDef_t *item) 
{
	...
	} else if (feederID == FEEDER_MD3) {// CODE1234
		uiInfo.md3Index = index;
	} else if (feederID == FEEDER_EFX) {
		uiInfo.efxIndex = index;
	} else if (feederID == FEEDER_NPCS) {
		uiInfo.NPCIndex = index;
	} else if (feederID == FEEDER_NPCVS) {
		uiInfo.NPCVIndex = index;
	} else if (feederID == FEEDER_ANIMS) {
		uiInfo.AnimIndex = index;
	} else if (feederID == FEEDER_ANIMS2) {
		uiInfo.Anim2Index = index;
	} else if (feederID == FEEDER_ANIMS3) {
		uiInfo.Anim3Index = index;
	} else if (feederID == FEEDER_PERMS) {
		uiInfo.PermIndex = index;
	}
	else if (feederID == FEEDER_COLORCHOICES) 
	{
		if (index >= 0 && index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].ColorCount)
...
void _UI_Init( qboolean inGameLoad ) {
	...
	// Makermod v2.0
	trap_Cvar_Register(NULL, "mm_client", MM_CLIENT_VERSION, CVAR_USERINFO | CVAR_ROM );
...
//			Menus_ActivateByName("ingame_player");
			Menus_ActivateByName("crpg_ingame_login");
			//C-RPG
			UpdateForceUsed();
		  return;
	...
	/*  case UIMENU_MAKERMOD:
		 // trap_Cvar_Set( "cl_paused", "1" );
			...
			trap_Key_SetCatcher( KEYCATCH_UI );
			Menus_CloseAll();
			Menus_ActivateByName("ingame_makermod");
			return;*/
